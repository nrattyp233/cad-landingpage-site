...
const LandingPage: React.FC = () => {
    ...
    return (
        <div className="min-h-screen w-full bg-dark-1 font-montserrat text-light-1 overflow-x-hidden">
            {/* Header */}
            ...
            {/* Footer */}
            <footer className="w-full py-6 bg-dark-2 border-t border-dark-3">
                <div className="container mx-auto px-4 text-center">
